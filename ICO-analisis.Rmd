...
#### 1. Relacionar la frecuencia con la que la muestra come fuera de casa y el motivo principal
...
Tras realizar la agrupación de categorías en la variable frecuencia ('0-2/sem' y '3+/sem'), se verifica el cumplimiento de la condición de validez del test de Chi-cuadrado.
Todos los valores "expected" \> 5.

El p-valor \< 0,05 permite rechazar la hipótesis nula.
Por consiguiente, se concluye que existe una dependencia entre el motivo y la frecuencia de consumo extradoméstico.
...
-   **Perfil de Placer/Extraordinario:** En contraste, los motivos vinculados al ocio o eventos extraordinarios presentan una concentración mayoritaria en el rango de baja frecuencia (0-2 veces por semana).
...
El objetivo es determinar si el lugar donde se consume influye en el tipo de comida elegido.
Al tratarse de una variable de respuesta múltiple, analizaremos la dependencia por separado para las opciones más relevantes: comida de elaboración propia, comida rápida y platos preparados de supermercado.
