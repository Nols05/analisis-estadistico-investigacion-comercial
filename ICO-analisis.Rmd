...
El p-valor \< 0,05 permite rechazar la hipótesis nula, por consiguiente, se concluye que existe una dependencia entre el motivo y la frecuencia de consumo extradoméstico. El análisis de las frecuencias relativas por filas revela diferencias estructurales en los perfiles de consumo:
