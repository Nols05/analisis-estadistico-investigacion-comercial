...
datos %>%
  ...
  flextable::flextable() %>%
  set_caption("Tabla 26. Estadísticos descriptivos: Importancia Saludable (1-5) según Intención de Uso.") %>%
...
ggpubr::ggboxplot(datos, 
          ...
          xlab = "Intención de Uso",
          title = "Figura. Distribución de la Importancia Saludable según Aceptación")
```
...
ggpubr::ggqqplot(residuals(modelo_salud)) +
  labs(title = "Gráfico QQ de los residuos (Importancia Saludable)")
...
data.frame(
  ...
  flextable::flextable() %>%
  set_caption("Tabla 27. Test de Normalidad de Anderson-Darling (Residuos).") %>%
...
res_kruskal %>%
  flextable::flextable() %>%
  set_caption("Tabla 28. Resultados del Test de Kruskal-Wallis (Relevancia Salud vs Aceptación).") %>%
